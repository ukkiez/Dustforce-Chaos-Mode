...
class PolishDriver : Mode, Random {
  ModeConfig get_mode_config() {
    return ModeConfig( 20, "Polish Driver" );
  }
  ...
  void deactivate() {
    ...
    @car_hitbox = Box( -150, -105, 145, 110 );
    ...
    crash_scaling_x = 0.3;
    crash_rotation1 = -32.5;
    crash_rotation2 = -7;

    stun_direction_x = -2500;
    stun_direction_y = -750;
